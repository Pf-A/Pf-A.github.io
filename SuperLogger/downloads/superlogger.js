...
function superLoggerInstall() {
    console.log = superlog;
    console.error = supererror;
    console.warn = superwarn;
    console.debug = superdebug;
    console.clear = superclear;
    console.log('SuperLogger installed successfully.');
}
...
// Automatically run the logger test and installation
superLoggerAutoRun();
superLoggerInstall();
